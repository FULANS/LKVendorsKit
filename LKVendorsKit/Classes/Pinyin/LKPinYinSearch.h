...
@interface LKPinYinSearch : NSObject
 ...
 *  @example   _dataSourceArray = [LKPinYinSearch searchWithOriginalArray:_originalArray andSearchText:searchBar.text andSearchByPropertyName:@"name"];
 */

...
/**
 ...
 @param photos 所有图片数组，支持PHAsset、UIImage、NSURL对象 [注意传入 NSURL 对象的时候,传入fileType类型]
...
/// 用户点击了保存按钮
@property (nonatomic, copy) void (^saveButtonClickBlock)(BOOL isSuccess,NSString *message);
@end
